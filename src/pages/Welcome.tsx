        ...
        <div className='text-[64px] w-8xl p-4 mb-4 text-white font-mono bg-gradient-to-r from-transparent via-transparent to-transparent bg-opacity-50 backdrop-filter h-screen backdrop-blur-lg flex justify-center'>
          <div className='fixed bottom-4'>
            <div className='text-left  '>
              <h1 className='lg:text-7xl text-3xl text-left'>Turfer</h1>
              <h1 className='lg:text-[32px] text-lg mb-8 text-lefttext-white font-mono'>
                Book turfs easily
              </h1>
              <SignInButton>
                <button className='max-w-3xl mx-auto px-32 py-4 text-xl bg-blue-700 hover:bg-black hover:text-white backdrop-filter backdrop-blur-lg  rounded-md'>
