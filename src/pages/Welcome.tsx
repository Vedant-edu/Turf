...
export default function Page() {
  return (
    <div className='flex justify-center max-w-3xl mx-auto' style={{ backgroundImage: 'url(https://raw.githubusercontent.com/Vedant-edu/Turf/main/images/topground.jpg)', backgroundSize: 'cover' }}>
